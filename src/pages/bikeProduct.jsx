                                        ...
                                        {cardData.map((card) => (
                                            ...
                                            >
                                                <div className="cardTitle">
                                                    ...
                                                    <strong>{card.bike.bikeName}</strong>
                                                </div>
                                                <div className="cardContainer">
                                                    <figure>
                                                        <img src={"http://localhost:5173/@fs/D:/Sem_6/drive-ease-backend/assets/bikesImage/" + card.bike.imageUrl} alt="" />
                                                    </figure>
                                                ...
                                                <div className="cardBtm">
                                                    <div className="priceDetails">
                                                        <b>Deal!</b>
                                                        <strong className="price">{card.bike.amount}</strong>
                                                        <b>onwards</b>
                                                    </div>
