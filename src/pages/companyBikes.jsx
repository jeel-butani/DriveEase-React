...
const companyBikes = () => {
    ...
    const fetchData = async () => {
        const getBikeResponse = await axios.get(`http://localhost:3000/api/company/${ids}/bikes`);
        console.log(getBikeResponse.data.bikes)
        setBikeData(getBikeResponse.data.bikes);
    }
    ...
    const handleSelect = (id) => {
        ...
        window.location.href = `/editBike/${compoanyId}/${encodedId}`;
    };
                    ...
                    <div className="templateRow1">
                        ...
                        <div className="tabWidget">
                            <div className="flex justify-between items-center">
                                ...
                                <button className="button text-xl font-bold" onClick={handleCar}>Cars</button>
                                        ...
                                        bikeData.map((bike) => (
                                            ...
                                            >
                                                <div className="cardTitle">
                                                    ...
                                                    <strong>{bike.bike.bikeName}</strong>
                                                </div>
                                                <div className="cardContainer">
                                                    <figure>
                                                        <img src={"http://localhost:5173/@fs/D:/Sem_6/drive-ease-backend/assets/bikesImage/" + bike.bike.imageUrl} alt="" />
                                                    </figure>
                                                ...
                                                <div className="cardBtm">
                                                    <div className="priceDetails">
                                                        <b>Deal!</b>
                                                        <strong className="price">{bike.bike.amount}</strong>
                                                        <b>onwards</b>
                                                    </div>
                                                    <div className="cardCtrl">
                                                        <button
                                                            onClick={() => handleSelect(bike.hexId)}
                                                ...
                                                <div className="totalCars text-xl font-bold">
                                                    Total Bikes: {bike.bike.totalCount}
                                                </div>
                                                <div className="totalCars text-l font-bold">
                                                    Available Bikes: {bike.bike.availableCount}
                                                </div>
                                            </div>
                                        ))
                                    )}
