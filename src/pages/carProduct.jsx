    ...
    return (
        <>
            ...
            <section className='bookingWidget'>
                        ...
                        <div className="navWidget">
                            ...
                            <div class="locationList locationFrom">
                                <div class="locationCol">
                                    ...
                                    <div class="time">8:30<span>AM</span></div>
                                </div>
                                <div class="forIcon">
                                    <img src="https://evmwheels.com/front-theme/images/next.png" alt=""/>
                                </div>
                                <div class="locationCol">
                            ...
                            <div class="filterWidget1">
                                <div class="filterWidget">
                                    <div class="filterTitle">
                                        ...
                                        <h3>Filters</h3>
                                        <a href="#" class="resetBtn">Reset all</a>
                                    </div>
                                    <div class="filterBody">
                                            ...
                                            <div class="colapsBody">
                                                <div class="filterRow center">
                                                    <div class="radioCheck">
                                                        <input type="checkbox" name="transmission[]" class="radioBtn transmission_filter" id="transmission" value="1"/>
                                                        <label for="transmission">Manual</label>
                                                    </div>
                                                    <div class="radioCheck">
                                                        <input type="checkbox" name="transmission[]" class="radioBtn transmission_filter" id="transmission" value="2"/>
                                        ...
                                        <div class="filterList">
                                            ...
                                            <div class="filterRow center">
                                                <div class="radioCheck">
                                                    <input type="checkbox" name="fuel[]" class="radioBtn fuel_filter" id="transmission" value="1"/>
                                                    <label for="transmission">Petrol</label>
                                                </div>
                                                <div class="radioCheck">
                                                    <input type="checkbox" name="fuel[]" class="radioBtn fuel_filter" id="transmission" value="2"/>
                                                    <label for="transmission">Diesel</label>
                                                </div>
                                                <div class="radioCheck">
                                                    <input type="checkbox" name="fuel[]" class="radioBtn fuel_filter" id="transmission" value="3"/>
                                        ...
                                        <div class="filterList">
                                            ...
                                            <div class="brandContainer">
                                                <div class="filterCol center">
                                                    <div class="radioCheck">
                                                        <input type="checkbox" name="brand[]" class="checkBtn brand_filter" id="transmission" value="4"/>
                                                        <label for="transmission">MG</label>
                                                    </div>
                                                    <div class="radioCheck">
                                                        <input type="checkbox" name="brand[]" class="checkBtn brand_filter" id="transmission" value="5"/>
                                                        <label for="transmission">TATA</label>
                                                    </div>
                                                    <div class="radioCheck">
                                                        <input type="checkbox" name="brand[]" class="checkBtn brand_filter" id="transmission" value="6"/>
                                                        <label for="transmission">TOYOTA</label>
                                                    </div>
                                                    <div class="radioCheck">
                                                        <input type="checkbox" name="brand[]" class="checkBtn brand_filter" id="transmission" value="7"/>
                                                        <label for="transmission">ISUZU</label>
                                                    </div>
                                                    <div class="radioCheck">
                                                        <input type="checkbox" name="brand[]" class="checkBtn brand_filter" id="transmission" value="8"/>
                                                        <label for="transmission">VW</label>
                                                    </div>
                                                    <div class="radioCheck">
                                                        <input type="checkbox" name="brand[]" class="checkBtn brand_filter" id="transmission" value="9"/>
                                                        <label for="transmission">SKODA</label>
                                                    </div>
                                                    <div class="radioCheck">
                                                        <input type="checkbox" name="brand[]" class="checkBtn brand_filter" id="transmission" value="10"/>
                                                        <label for="transmission">NISSAN</label>
                                                    </div>
                                                    <div class="radioCheck">
                                                        <input type="checkbox" name="brand[]" class="checkBtn brand_filter" id="transmission" value="11"/>
                                                        <label for="transmission">DATSUN</label>
                                                    </div>
                                                    <div class="radioCheck">
                                                        <input type="checkbox" name="brand[]" class="checkBtn brand_filter" id="transmission" value="12"/>
                                                        <label for="transmission">HYUNDAI</label>
                                                    </div>
                                                    <div class="radioCheck">
                                                        <input type="checkbox" name="brand[]" class="checkBtn brand_filter" id="transmission" value="13"/>
                                                        <label for="transmission">MAHINDRA</label>
                                                    </div>
                                                    <div class="radioCheck">
                                                        <input type="checkbox" name="brand[]" class="checkBtn brand_filter" id="transmission" value="14"/>
                                                        <label for="transmission">SUZUKI</label>
                                                    </div>
                                                    <div class="radioCheck">
                                                        <input type="checkbox" name="brand[]" class="checkBtn brand_filter" id="transmission" value="15"/>
                                                        <label for="transmission">CITREON</label>
                                                    </div>
                                                    <div class="radioCheck">
                                                        <input type="checkbox" name="brand[]" class="checkBtn brand_filter" id="transmission" value="26"/>
                ...
                {cardData.map(card => (
                        <div key={card.id} className="carCol" data-id="1" data-transmission="1" data-fuel="1">
                                    ...
                                    <a href="#" class="speList">
                                        <div class="icon">
                                            <svg width="15" height="15" viewBox="0 0 9 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M1.1001 0.949951V6.04995M4.5001 0.949951V6.04995M1.1001 3.49995H5.3501C6.1423 3.49995 6.5384 3.49995 6.85035 3.37075C7.05674 3.28531 7.24428 3.16004 7.40223 3.00209C7.56019 2.84413 7.68546 2.6566 7.7709 2.4502C7.9001 2.13825 7.9001 1.74215 7.9001 0.949951" stroke="#9C9C9C" stroke-linecap="round"></path>
                                            </svg>
                                        </div>
                                        {card.transmission}
                                    </a>
                            ...
                            <div className="cardBtm">
                                ...
                                <div className="cardCtrl">
                                    <a href="https://evmwheels.com/choose-plan" className="selectBtn open-inv-popup" data-id="31">
                                        Select
                                        <svg width="13" height="13" viewBox="0 0 11 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule="evenodd" clipRule="evenodd" d="M2.005 0L10.005 8L2.005 16L0 14L6.005 8L0 2L2.005 0Z" fill="white"></path>
                                        </svg>
                                    </a>
                                </div>
                            </div>
