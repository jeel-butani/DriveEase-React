            ...
            <div class="grid md:grid-cols-2">
              <div class="h-full pr-6">
                <p class="mt-3 mb-12 text-lg text-gray-600">
                  Welcome to DriveEase! We're thrilled to have you on board. Whether you're looking to rent a car for your next road trip or a bike for a quick city exploration, we're here to make your experience seamless and enjoyable.
                </p>
                <ul class="mb-6 md:mb-0">
                  <li class="flex">
                    ...
                    <div class="ml-4 mb-4">
                      <h3 class="mb-2 text-lg font-medium leading-6 text-gray-900">DriveEase Car Rentals
                      </h3>
                  ...
                  <li class="flex">
                    ...
                    <div class="ml-4 mb-4">
                      <h3 class="mb-2 text-lg font-medium leading-6 text-gray-900">DriveEase Bike Rentals
                      </h3>
                      <p class="text-gray-600">1230 Maecenas Street Donec Road</p>
                      <p class="text-gray-600">New York, EEUU</p>
                    </div>
                ...
                <form id="contactForm">
                  <div class="mb-6">
                    <div class="mx-0 mb-1 sm:mb-4">
                      <label for="name" class="pb-1 text-xs uppercase tracking-wider"></label><input
                        ...
                        class="mb-2 w-full bg-white rounded-md border border-gray-400 py-2 pl-2 pr-4 shadow-md"
                        name="name" />
                    </div>
                    <div class="mx-0 mb-1 sm:mb-4">
                  ...
                  <div class="mx-0 mb-1 sm:mb-4">
                    <label for="textarea" class="pb-1 text-xs uppercase tracking-wider"></label><textarea
                      ...
                      class="mb-2 w-full bg-white rounded-md border border-gray-400 py-2 pl-2 pr-4 shadow-md"></textarea>
                  </div>
