  ...
  return (
    <>
      ...
      <div className="flex justify-between items-center">
        ...
        <button className="btn text-xl font-bold" onClick={handleCars}>Cars </button>
        <button className="btn  text-xl font-bold" onClick={handleCarDriver}>Add Driver/Cars</button>
      </div>
